...
import { adminStats, auditLogs } from "@/lib/mockData";
    ...
    <>
      ...
      <div className="grid lg:grid-cols-3 gap-5">
        <Card className="p-6 lg:col-span-2">
          <h3 className="font-semibold text-brand-ink mb-4">Recent Activity</h3>
          <div className="space-y-3">
            {auditLogs.slice(0, 5).map((l, i) => (
              <div key={i} className="flex items-start gap-3 border-b border-brand-border pb-3 last:border-0 last:pb-0">
        ...
        <Card className="p-6 h-fit">
          <h3 className="font-semibold text-brand-ink mb-4">System Health</h3>
          {[
