  ...
  return (
    <>
      ...
      <div className="space-y-5">
        {/* Profile Information */}
        <Card className="p-6">
          <h3 className="font-semibold text-brand-ink mb-5">Profile Information</h3>
          ...
          <button className="mt-6 bg-brand-blue text-white px-5 py-2.5 rounded-btn text-sm font-medium hover:bg-brand-dark transition-colors">Save Changes</button>
        </Card>

        {/* Security: Change Password */}
        <Card className="p-6">
          <h3 className="font-semibold text-brand-ink mb-5 flex items-center gap-2">
        ...
        <Card className="p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between border border-brand-blue/30 bg-brand-blue/5 rounded-btn px-4 py-3.5">
              ...
              <span className="text-xs font-medium text-brand-blue bg-brand-blue/10 px-2.5 py-1 rounded-full">Current</span>
            </div>
            <div className="flex items-center justify-between border border-brand-border rounded-btn px-4 py-3.5">
              <div className="flex items-center gap-3">
              ...
              <button className="text-xs font-medium text-brand-danger hover:underline">Logout</button>
            </div>
          </div>
          <button className="mt-5 flex items-center gap-2 border border-brand-border text-brand-gray px-4 py-2.5 rounded-btn text-sm font-medium hover:bg-brand-bg transition-colors">
