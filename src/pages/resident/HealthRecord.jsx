...
import { HeartPulse, Syringe, Droplet, Thermometer, Activity, FlaskConical } from "lucide-react";
...
export default function HealthRecord() {
  return (
    <>
      <PageHeader crumbs={["Home", "My Health Record"]} title="My Health Record" subtitle="A complete view of your medical history and vitals." />
