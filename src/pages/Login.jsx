...
export default function Login() {
  ...
  const submit = (e) => {
    e.preventDefault();
    // Unverified residents are redirected to the verification status page
    if (role === "resident") {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-brand-bg">
      ...
      <div className="hidden lg:flex relative flex-col justify-between p-12 bg-brand-blue overflow-hidden">
        ...
        <div className="relative bg-white rounded-xl p-3 inline-block w-fit"><img src={LOGO_URL} alt="KALUSAGAP" className="h-16 w-auto" /></div>
      ...
      <div className="flex items-center justify-center p-6 md:p-12">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="w-full max-w-md">
          <div className="lg:hidden mb-8"><img src={LOGO_URL} alt="KALUSAGAP" className="h-16 w-auto" /></div>
