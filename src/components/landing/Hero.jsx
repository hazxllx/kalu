      ...
      <div className="max-w-content mx-auto px-5 md:px-8 grid lg:grid-cols-2 gap-14 items-center">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, delay: 0.1 }} className="relative">
          <div className="relative rounded-[28px] overflow-hidden shadow-float">
            <img src="https://images.unsplash.com/photo-1631815588090-d4bfec5b1ccb?auto=format&fit=crop&w=1200&q=80" alt="Community healthcare" className="w-full h-[300px] md:h-[440px] object-cover" />
            <div className="absolute inset-0 bg-gradient-to-tr from-brand-dark/40 via-brand-blue/10 to-transparent" />
          </div>
