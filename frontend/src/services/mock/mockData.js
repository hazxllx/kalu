...
// health indicators (those belong to the nurse/midwife roles).
export const bhwDashboard = [
  { icon: "Home", label: "Households Profiled", value: "148", tone: "green" },
  { icon: "ClipboardList", label: "Pending Household Visits", value: "9", tone: "yellow" },
  { icon: "AlertTriangle", label: "High-Risk Households", value: "17", tone: "danger" },
  { icon: "UserPlus", label: "New Registrations", value: "23", tone: "accent" },
  { icon: "RefreshCw", label: "Records Pending Sync", value: "3", tone: "blue" },
];
...
export const healthServices = [
  { name: "Medical Consultation", schedule: "Daily 8:00 AM - 12:00 PM", personnel: "Midwife M. Dela Cruz", enrolled: 42, status: "Ongoing" },
  { name: "Dental Services", schedule: "Thursday 8:00 AM - 12:00 PM", personnel: "Dentist", enrolled: 28, status: "Ongoing" },
  { name: "Immunization", schedule: "Tuesday & Thursday 1:00 PM - 3:00 PM", personnel: "BHW M. Cruz", enrolled: 35, status: "Ongoing" },
  { name: "Risk Assessment / Visual Acuity / PWD Screening", schedule: "Friday 9:00 AM - 11:00 AM", personnel: "RHU Nurse", enrolled: 18, status: "Scheduled" },
  { name: "Distribution of Hypertension / Diabetic Medication", schedule: "Monday & Wednesday 8:00 AM - 12:00 PM", personnel: "Midwife M. Dela Cruz", enrolled: 34, status: "Scheduled" },
  { name: "Cervical Screening", schedule: "Last Thursday of Month", personnel: "Midwife M. Dela Cruz", enrolled: 21, status: "Scheduled" },
  { name: "Nutrition Operation Timbang", schedule: "Quarterly", personnel: "Nutrition Scholar", enrolled: 45, status: "Scheduled" },
  { name: "Nutrition Deworming", schedule: "Semi-annual", personnel: "Nutrition Scholar", enrolled: 38, status: "Scheduled" },
  { name: "Nutrition Micronutrient Supplement", schedule: "Monthly", personnel: "Nutrition Scholar", enrolled: 52, status: "Scheduled" },
  { name: "TB Program", schedule: "Daily 8:00 AM - 5:00 PM", personnel: "RHU Nurse", enrolled: 15, status: "Ongoing" },
