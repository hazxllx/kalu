...
export const phnCheckupQueue = [
  { id: 1, patient: "Rosa Dimagiba", age: 34, sex: "Female", barangay: "San Isidro", consultationLocation: "San Isidro Barangay Health Center", reason: "BP re-check", status: "Waiting for PHN", queuedAt: "8:40 AM", notes: "San Isidro resident; BP re-check at the San Isidro Barangay Health Center." },
  { id: 2, patient: "Elena Garcia", age: 25, sex: "Female", barangay: "San Isidro", consultationLocation: "San Isidro Barangay Health Center", reason: "Prenatal assessment", status: "Waiting for PHN", queuedAt: "9:05 AM", notes: "Referred by BHS San Isidro." },
  { id: 3, patient: "Marites Ramos", age: 41, sex: "Female", barangay: "San Isidro", consultationLocation: "San Isidro Barangay Health Center", reason: "Cough for 2 weeks", status: "Waiting for PHN", queuedAt: "9:20 AM", notes: "TB symptom screening requested." },
  { id: 4, patient: "Dante Villar", age: 58, sex: "Male", barangay: "San Antonio", consultationLocation: "San Antonio Barangay Health Center", reason: "Uncontrolled hypertension", status: "Waiting for PHN", queuedAt: "9:35 AM", notes: "Referred by BHS San Antonio." },
  { id: 5, patient: "Sofia Reyes", age: 7, sex: "Female", barangay: "Old San Roque", consultationLocation: "Old San Roque Barangay Health Center", reason: "Nutrition follow-up", status: "Waiting for PHN", queuedAt: "10:00 AM", notes: "Referred by BHS Old San Roque." },
...
export const phnResidents = [
  ...
  // San Antonio resident — hypertension review conducted at the RHU main.
  { id: "R-2002", name: "Juan Dela Cruz", age: 45, gender: "Male", barangay: "San Antonio", risk: "High", status: "Active", program: "Hypertension" },
  ...
  // San Isidro residents (consultation at the San Isidro Barangay Health Center
...
export const phnReferrals = [
  // San Isidro resident — BP re-check at the San Isidro Barangay Health Center.
  { id: 1, referralNo: "RH-2026-000301", resident: "Rosa Dimagiba", age: 34, sex: "Female", barangay: "San Isidro", date: "September 5, 2026", reason: "BP re-check at BHS", facility: "RHU Pili", priority: "Medium", status: "For Review", referringPersonnel: "RHU Personnel A. Reyes", notes: "San Isidro resident; BP re-check at the San Isidro Barangay Health Center." },
  // San Isidro resident — diabetes review conducted at the RHU main.
  { id: 2, referralNo: "RH-2026-000302", resident: "Andres Banaag", age: 60, sex: "Male", barangay: "San Isidro", date: "September 4, 2026", reason: "Diabetes medication review", facility: "RHU Pili", priority: "High", status: "For Review", referringPersonnel: "RHU Personnel A. Reyes", notes: "San Isidro resident; diabetes review conducted at the RHU main." },
  // San Isidro
  { id: 3, referralNo: "RH-2026-000303", resident: "Elena Garcia", age: 25, sex: "Female", barangay: "San Isidro", date: "September 5, 2026", reason: "Maternal concern", facility: "RHU Pili", priority: "High", status: "For Review", referringPersonnel: "Midwife M. Dela Cruz", notes: "Elevated blood pressure on latest prenatal visit. Requires specialist evaluation." },
  ...
  { id: 9, referralNo: "RH-2026-000309", resident: "Carlos Mendoza", age: 61, sex: "Male", barangay: "San Antonio", date: "August 28, 2026", reason: "Diabetes foot screen", facility: "RHU Pili", priority: "High", status: "Completed", referringPersonnel: "BHW L. Ramos", notes: "Foot screen completed with no active ulcer." },
  // Old San Roque
  ...
  { id: 14, referralNo: "RH-2026-000314", resident: "Manuel Fernandez", age: 47, sex: "Male", barangay: null, date: "September 4, 2026", reason: "Diabetes management review", facility: "RHU Pili", priority: "High", status: "Pending", referringPersonnel: "Midwife M. Dela Cruz", notes: "RHU-level diabetes follow-up; FBS trending upward on the current regimen." },
...
export const phnFollowUps = [
  ...
  // San Isidro resident — follow-up at the San Isidro Barangay Health Center.
