...
export const NAV = {
  ...
  // follow-ups and barangay community monitoring / early warning.
  health_supervisor: [
    { label: "Dashboard", icon: "LayoutDashboard", path: "/app/health_supervisor/dashboard" },
    { label: "Resident Directory", icon: "Users", path: "/app/health_supervisor/residents", permission: "residents.directory.view" },
    { label: "Verifications", icon: "ShieldCheck", path: "/app/health_supervisor/verifications", permission: "residents.registration.approve" },
    { label: "Consultation", icon: "Stethoscope", path: "/app/health_supervisor/consultations", permission: "consultation.conduct" },
    ...
    { label: "Health Services", icon: "Activity", path: "/app/health_supervisor/services" },
    { label: "Immunization", icon: "Syringe", path: "/app/health_supervisor/immunization" },
    { label: "Referrals", icon: "Send", path: "/app/health_supervisor/referrals", permission: "referrals.view" },
    { label: "Community Monitoring", icon: "Map", path: "/app/health_supervisor/barangays", permission: "reports.analytics.view" },
    { label: "Early Warning", icon: "TrendingUp", path: "/app/health_supervisor/trends", permission: "reports.analytics.view" },
    { label: "Reports", icon: "BarChart3", path: "/app/health_supervisor/reports", permission: "reports.view" },
    { label: "Notifications", icon: "Bell", path: "/app/health_supervisor/notifications" },
    { label: "Settings", icon: "Settings", path: "/app/health_supervisor/settings" },
  ],
