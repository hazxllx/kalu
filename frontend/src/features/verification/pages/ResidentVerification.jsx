...
import {
  ArrowLeft, User, MapPin, Calendar, Phone, FileText, ShieldCheck,
  CheckCircle2, XCircle, FileWarning, AlertTriangle, ImageIcon,
} from "lucide-react";

// Identity review only — personal medical information is not surfaced to the
// BHW and remains with the nurse/midwife roles.
const RESIDENT = {
