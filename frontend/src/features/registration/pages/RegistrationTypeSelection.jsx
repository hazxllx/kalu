...
const options = [
  ...
  },
  {
    ...
    icon: Building2,
    code: "FORM D",
    title: "Register a Municipality",
    copy: "For local government units (LGUs) registering in KALUSAGAP. Creates a pending application reviewed by the System Administrator.",
    to: "/register/municipality",
    cta: "Continue",
    requirements: [
      { icon: Building2, label: "Official municipality / LGU information" },
      { icon: IdCard, label: "Authorized representative details and ID" },
      { icon: FileCheck2, label: "Legal / supporting documents" },
    ],
    note: "Applications are reviewed before municipality-level access is granted.",
  },
  {
    key: "official",
    icon: UserPlus,
