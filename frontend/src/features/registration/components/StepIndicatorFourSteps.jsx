...
export default function StepIndicator4({ current, completed = [] }) {
  const STEPS = [
            ...
            <div key={step.num} className="flex flex-1 items-start last:flex-none">
              <div className="flex w-[52px] flex-col items-center gap-2">
                <motion.div
                  initial={false}
                  animate={{
                    backgroundColor: state === "pending" ? "#FFFFFF" : "#12518F",
                    borderColor: state === "pending" ? "#DCE4EE" : "#12518F",
                  }}
